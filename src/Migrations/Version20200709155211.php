 ...
 */
final class Version20200709155211 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE players (id INT NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, api_token VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_264E43A6F85E0677 ON players (username)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_264E43A67BA2F5EB ON players (api_token)');
